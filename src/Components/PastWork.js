...
const PastWork = () => {
    return (
        <div id="past-work">
                ...
                <a href="https://drive.google.com/file/d/1QRblFWqlQPfg2jKX3aN6tmvr7vh5Uh-7/view?usp=sharing" target='_blank'>Certificate <HiOutlineExternalLink/></a>
                </div>
                <div className='card'>
                    <img src={TEN}/>
                ...
                <a href="https://drive.google.com/file/d/1l9OlVn5ONjZQhsZ2o0e4tLbwMCMxu_Yq/view?usp=sharing" target='_blank'>Certificate <HiOutlineExternalLink/></a>
                </div>
        </div>
    )
}
